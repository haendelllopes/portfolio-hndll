        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {products.map((product) => {
            ...
            if (route) {
              return (
                <Link
                  key={product.name}
                  href={route}
                  className="bg-white rounded-xl p-10 md:p-12 border border-gray-100 hover:border-gray-200 hover:shadow-xl hover:-translate-y-1 hover:scale-[1.02] transition-all duration-300 ease-in-out cursor-pointer block flex flex-col"
                >
            ...
            return (
              <div
                key={product.name}
                className="bg-white rounded-xl p-10 md:p-12 border border-gray-100 hover:border-gray-200 hover:shadow-xl hover:-translate-y-1 hover:scale-[1.02] transition-all duration-300 ease-in-out cursor-pointer flex flex-col"
              >
                <div className="flex-1">
                  <h3 className="text-3xl md:text-4xl font-bold text-[#0a0a0a] mb-6 leading-tight">
                    {product.name}
